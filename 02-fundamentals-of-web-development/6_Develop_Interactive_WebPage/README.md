# Curso: Creación de una Página Web de Lista de Tareas Interactiva

En este curso, practicará la creación de una página web de lista de tareas interactiva en una serie de simulaciones. Desarrollará archivos de código que diseñan la estructura de una página web con HTML, añadirá estilos con CSS, desarrollará interacciones con JavaScript y a continuación probará que la página web funcione de la forma prevista.
