...
En este curso, conocerá las funciones informáticas y los lenguajes de programación básicos. Verá una descripción general del desarrollo web, que incluye el ámbito de ambos lados del desarrollo web: front-end y back-end. Descubrirá la diferencia entre Internet y la World Wide Web.
